...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_txtPassword'), 'B7VUtBG5mksCulKkvTxKdg==')

WebUI.sendKeys(findTestObject('Object Repository/Page_OrangeHRM/input_Username_txtPassword'), Keys.chord(Keys.ENTER))
